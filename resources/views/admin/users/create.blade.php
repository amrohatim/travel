...
<div class="panel" style="max-width: 760px;">
    ...
    <form method="POST" action="{{ route('admin.users.store') }}" class="row g-3" enctype="multipart/form-data">
        ...
        <div class="col-md-6" id="parent-company-field" @if (old('role') !== 'office') style="display: none;" @endif>
            ...
            <select name="parent_company_id" class="form-select" id="parent-company-select">
                ...
                @foreach ($parentCompanies as $parentCompany)
                    <option value="{{ $parentCompany->id }}" @selected((string) old('parent_company_id') === (string) $parentCompany->id)>{{ $parentCompany->name }}</option>
                @endforeach
            </select>
        </div>

        <div class="col-md-6" id="state-field" @if (old('role') !== 'office') style="display: none;" @endif>
        ...
        <div class="col-md-6" id="lat-field" @if (old('role') !== 'office') style="display: none;" @endif>
