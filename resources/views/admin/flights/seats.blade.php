...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="h4 mb-1">Flight Seats</h1>
        <p class="mb-0 text-secondary">{{ $flight->from }} → {{ $flight->to }} | {{ $flight->travel_date }}</p>
    </div>
...
<div class="panel">
    ...
    @else
        <p class="mb-0 text-secondary">No seats found for this flight.</p>
    @endif
</div>
@endsection
